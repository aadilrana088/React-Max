  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        {this.state.showCockpit ? <Cockpit persons = {this.state.persons} appTitle={this.props.appTitle} color={"this.state.showPerson"} togglePerson = {this.togglePerson} />: null}
        {persons}
      </div>
    )
  }
